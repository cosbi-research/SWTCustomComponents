...
public class LateralTabFolder extends Composite {
    ...
    private PaintListener paintRect, paintLinesUp, paintLinesRight, paintLinesDown, paintLinesCompTabs,
	    paintTabModified;
    private Rectangle rect;
    private Color colorLines = new Color(getDisplay(), 210, 210, 210);
	...
	lblTitle.setBackground(new Color[] { headerColor, getDisplay().getSystemColor(SWT.COLOR_WHITE), },
		new int[] { 100 });
