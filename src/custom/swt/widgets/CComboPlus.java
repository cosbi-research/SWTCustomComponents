...
/**
 * The CComboPlus is a modified version of {@link org.eclipse.swt.custom.CCombo} class 
 * and represents a selectable user interface object that combines a text field and a list and issues notification
 * when an item is selected from the list.
 * <p>
 * CComboPlus provides new methods for having item selection on mouse hover
 * {@link #setMouseHoverSelection(boolean) setMouseHoverSelection} which is enabled by default and also, 
 * for changing the text color of the editable text {@link #setTextForeground(Color) setTextForeground}
 * </p>
 * <p>
...
/**
 * Enables the selection of list items on mouse hover if argument is <code>true</code>,
 * otherwise it disables it.
 * 
 * @param enable - the new state of this feature
 *
 * @exception SWTException <ul>
 *    <li>ERROR_WIDGET_DISPOSED - if the receiver has been disposed</li>
 *    <li>ERROR_THREAD_INVALID_ACCESS - if not called from the thread that created the receiver</li>
...
/**
 * Sets the CCombo's text foreground color to the one specified by the argument
 * 
